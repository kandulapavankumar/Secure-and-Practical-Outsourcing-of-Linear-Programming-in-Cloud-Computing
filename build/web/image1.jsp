    ...
    <div id="templatemo_menu">
        ...
        <ul>
           <li><a href="userpage.jsp" >Home</a></li>
			...
			<li><a href="encryptionimage.jsp">Encryption/Decryption</a></li>
...
<table align="center" width="578" style="border:1px solid #d2d2d2;" bgcolor="#A3BBD6">
	...
	Statement st1=null;
	ResultSet rs1=null;
	String sql1="select * from image where status= \'offline\' and name='"+name+"'";
	try
	{
		...
		while(rs1.next())
	     {
			...
			%>
          <tr> 
		   <td width="185" align="left" class="paragraping1" style="color:#000000">Image Name</td>
		   <td width="63">:</td>
			...
			<tr>
			 ...
			 <td width="185"  align="left" class="paragraping1" style="color:#000000">Key</td>
			  <td>:</td>
			 <td height="68" class="paragraping1"><font color="#FF0000"><% out.println(rs1.getString(2));%></font></td>
			</tr>
			
			  <tr>
			  <td width="185" height="76" align="left" class="paragraping1" style="color:#000000">Description</td>
			   <td>:</td>
