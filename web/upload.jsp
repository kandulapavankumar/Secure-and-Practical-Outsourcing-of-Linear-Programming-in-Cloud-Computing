    ...
    <body>
        <%
            ...
            ServletContext context = getServletContext();
             String fPath = "";
            String on = "";
            String rp = context.getRealPath("\\Picture\\");
			     String dirName = rp.replace("\\build", "");
				  System.out.println(dirName + "[[[[[[[[[[[[");
            String paramname = null;
            String name = null, key = null, limit = null, des = null, image = null;
            ...
            try {
                ...
                while (files.hasMoreElements()) {
                    ...
                    if (paramname != null) {
                       ...
                       String nm = context.getRealPath("\\Picture\\" + image);
                ...
                if (x != 0) {
                    ...
                    try {
                     ...
                     // APPROACH #1: uploads first file using an InputStream
					    ...
					    String ff = fPath.replace("Picture", "Picture");
