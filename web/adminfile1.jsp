...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
        ...
        <ul>
            ...
            <li><a href="adminencryptionfile.jsp">Encrypt/Decrypt</a></li>
		...
		while(rs1.next())
	     {
			...
			<td width="425"  class="paragraping1"><a href="filelock.jsp?name=<% out.println(rs1.getString(1));%>" style="color:#FF0000">File Lock</a></td>
			</tr>
...
%>
 ...
 <br><br>
 <table align="center" width="640" style="border:1px solid #d2d2d2" bgcolor="#A3BBD6">
 <tr bgcolor="#910000">
	...
	try
	{
	   con1=databasecon.getconnection();
		...
		<tr>
			...
			<td width="286" height="61"  class="paragraping1" style="color:#000000"><% out.println(rs1.getString(1));%></td>	
			</tr>
			<tr>
			<td height="31" class="paragraping"  style="color:red;">Key</td>
			<td width="286" height="61"  class="paragraping1" style="color:#000000"><% out.println(rs1.getString(2));%></td>	
			</tr>
			<tr>
			<td height="31" class="paragraping"  style="color:red;">Description</td>
			...
			<td width="286"  class="paragraping1"><a href="fileunlock.jsp?name=<% out.println(rs1.getString(1));%>" style="color:#FF0000">File Unlock</a></td>
			</tr>
