...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
        ...
        <ul>
           ...
           <li><a href="fileupload.jsp" class="current">File Upload</a></li>
        ...
        <table align="center" width="950" class="post" >
            <tr>
                <td width="660" height="477" valign="top" ><br><br>
                    <table align="center" width="552"  style="border:1px solid #d2d2d2" bgcolor="#A3BBD6">
                        <FORM ENCTYPE="multipart/form-data" name="form3" ACTION="fileinsert.jsp" METHOD="POST" onSubmit="return validation();">
                            <tr>
                                <td  colspan="2" class="paragraping" background="images/pattern_bg.gif" align="center" style="color:#000000">File Upload Here</td>
                            </tr>
                            <tr>
                                <td width="237" height="53" class="paragraping1" style="color:#000000">File Name:</td>
                            ...
                            <tr>
                                <td height="54" class="paragraping1" style="color:#000000">File Description:</td>
                                <td><input type="text" name="des" style="border:1px #A8A8FF solid;font-family:verdana;padding:2px 2px 2px 2px;font-size:12px;"></td>
                            </tr>
                            <tr>
                                <td height="61" class="paragraping1" style="color:#000000">Upload File:</td>
