...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
        ...
        <ul>
            ...
            <li><a href="adminencryptiontext.jsp">Encrypt/Decrypt</a></li>
...
<td width="300" height="520" valign="top" >
<table width="314" align="center" bgcolor="#A3BBD6" >
<tr> 
		   <td width="131" align="left" class="paragraping1" style="color:#000000">Book Name</td>
		   <td width="14">:</td>
