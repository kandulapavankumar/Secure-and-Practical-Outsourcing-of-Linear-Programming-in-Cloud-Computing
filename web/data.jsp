...
<table align="center" width="996" >
	...
	try
	{
	   con=databasecon.getconnection();
        ...
        <td width="988" height="47"  colspan="4" align="right" class="paragraping1" style="color:#000000"><img src="images/online.jpg">&nbsp;&nbsp;Welcome <font color="#FF0000"><% out.println(rs.getString(9));%></font></td>
...
<tr>
<td colspan="3" class="paragraping1" align="center"><font color="#FF0000" size="+1">Search Text data Here</font></td>
</tr>
<tr>
